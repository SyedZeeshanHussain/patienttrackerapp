// Patient Tracker App's Firebase configuration
var firebaseConfig = {
    ...
    for (var i = 0; i < patients.length; i++) {
        tableRef.innerHTML += `
              ...
              <tr>
                  ...
                  <button onclick="deletePatient('${patients[i].key}')" data-toggle="modal"
                  data-target="#delPatient" class="btn btn-sm btn-danger">Delete Record</button>
                  </td>
              </tr>
              </table>
              `;
...
function deletePatient(patientKey) {
    var delPatient = document.getElementById('del');
    delPatient.onclick = function () {
